	...
	<main>
		...
		<section class="interactive-gallery">
		  <div class="thumbnail-row">
		    <img src="/resources/img/tag/다이어터.png" alt="item1" class="thumb" data-title="다이어터" data-desc="둥글둥글했던 시절은 안녕~ <br>건강한 식단과 운동으로 변화 중인 판다. 다이어터!<br>느리지만 꾸준하게,이제는 몸도 마음도 가벼워지는 중입니다.">
		    <img src="/resources/img/tag/멸치탈출.png" alt="item2" class="thumb" data-title="멸치탈출" data-desc="바람에도 흔들리던 말랐던 시절은 그만! <br>잘 먹고, 제대로 운동하며, 탄탄한 몸을 향해 달려가는 성장형 캐릭터 멸치 탈출!">
