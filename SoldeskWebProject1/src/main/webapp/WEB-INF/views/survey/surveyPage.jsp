...
<body>
	...
	<div class="container">
		...
		<form id="surveyForm" method="post">
			...
			<section>
				<label class="section-title">비건 여부</label>
			...
			<section>
				<label class="section-title">영양제 섭취 여부</label>
				<table class="option-table">
					<tr>
						<td><label><input type="checkbox" name="cDTO.supplements" value="비타민 B"> 비타민 B</label></td>
						<td><label><input type="checkbox" name="cDTO.supplements" value="비타민 D"> 비타민 D</label></td>
						<td><label><input type="checkbox" name="cDTO.supplements" value="비타민 C"> 비타민 C</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox" name="cDTO.supplements" value="마그네슘"> 마그네슘</label></td>
						<td><label><input type="checkbox" name="cDTO.supplements" value="칼륨"> 칼륨</label></td>
						<td><label><input type="checkbox" name="cDTO.supplements" value="아연"> 아연</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox" name="cDTO.supplements" value="철분"> 철분</label></td>
						<td><label><input type="checkbox" name="cDTO.supplements" value="오메가3"> 오메가3</label></td>
						<td><label><input type="checkbox" name="cDTO.supplements" value="프로바이오틱스"> 프로바이오틱스</label></td>
					</tr>
				</table>
			</section>
			...
			<section id="dietSection" class="goal-section hidden">
				...
				<section>
					<label class="section-title">식단 조절 방식</label>
		...
		<section>
			<label class="section-title">다이어트 시 어려운 점</label>
			<div class="inline-group">
			...
			<section id="healthSection" class="goal-section hidden">
				...
				<!-- 🧬 관심 기저질환 -->
			<section>
				<label class="section-title">관심 기저질환 (중복 선택)</label>
				<table class="option-table">
					<tr>
						<td><label><input type="checkbox" name="diseases" value="고혈압"> 고혈압</label></td>
						<td><label><input type="checkbox" name="diseases" value="당뇨"> 당뇨</label></td>
						<td><label><input type="checkbox" name="diseases" value="고지혈증"> 고지혈증</label></td>
						<td><label><input type="checkbox" name="diseases" value="심장병"> 심장병</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox" name="diseases" value="골다공증"> 골다공증</label></td>
						<td><label><input type="checkbox" name="diseases" value="빈혈"> 빈혈</label></td>
						<td><label><input type="checkbox" name="diseases" value="변비"> 변비</label></td>
						<td><label><input type="checkbox" name="diseases" value="통풍"> 통풍</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox" name="diseases" value="치주질환"> 치주질환</label></td>
						<td><label><input type="checkbox" name="diseases" value="신장결석"> 신장결석</label></td>
						<td><label><input type="checkbox" name="diseases" value="지루성 피부염"> 지루성 피부염</label></td>
						<td></td>
					</tr>
				</table>
			</section>
